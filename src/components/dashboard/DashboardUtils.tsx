...
export const formatDate = (dateString: string) => {
  ...
  // Show exact date and time in UTC like "Dec 19, 2024, 02:30 PM UTC"
  return date.toLocaleString('en-US', {
    ...
    minute: '2-digit',
    hour12: true,
    timeZone: 'UTC' // Force UTC display for scheduled items
  }) + ' UTC';
};
...
export const getPlatformIcon = (platform: string) => {
  ...
  switch (platformLower) {
    case 'facebook':
      return (
        <div className="w-4 h-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded flex items-center justify-center">
    ...
    case 'instagram':
      return (
        <div className="w-4 h-4 bg-gradient-to-r from-slate-700 via-slate-600 to-slate-500 rounded flex items-center justify-center">
          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    case 'twitter':
      return (
        <div className="w-4 h-4 bg-gradient-to-r from-gray-800 to-black rounded flex items-center justify-center">
          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    case 'youtube':
      return (
        <div className="w-4 h-4 bg-gradient-to-r from-red-600 to-red-700 rounded flex items-center justify-center">
          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    case 'tiktok':
      return (
        <div className="w-4 h-4 bg-gradient-to-r from-gray-800 to-black rounded flex items-center justify-center">
          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-.88-.05A6.33 6.33 0 0 0 4 15.38a6.33 6.33 0 0 0 10.3-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
          </svg>
        </div>
      );
    case 'pinterest':
    ...
    default:
      return (
        <div className="w-4 h-4 bg-gradient-to-r from-gray-600 to-gray-700 rounded flex items-center justify-center">
          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    case 'blog':
      return (
        <div className="w-4 h-4 text-gray-600">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" xmlSpace="preserve" fill="currentColor">
            <g>
